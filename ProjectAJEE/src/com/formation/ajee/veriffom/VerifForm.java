...
public class VerifForm {
	...
	public String nomVerif(String nom) {
		String retour = null;
		try {
			if (nom.matches("[^A-Za-zü-ÿ]") == false) {
				retour = nom;
			}
		} catch (Exception e) {
	...
	public String prenomVerif(String prenom) {
		String retour = null;
		try {
			if (prenom.matches("[^A-Za-zü-ÿ]") == false) {
				retour = prenom;
			}
		} catch (Exception e) {
			// TODO: handle exception
	...
	public String lieuNaissanceVerif(String lieuNaissance) {
		String retour = null;
		try {
			if (lieuNaissance.matches("[^A-Za-zü-ÿ]") == false) {
	...
	public String nationaliteVerif(String nationalite) {
		...
		try {
			...
			if (nationalite.matches("[^a-zü-ÿ]") == false) {
				retour = nationalite;
			}
		} catch (Exception e) {
	...
	public String fonctionVerif(String fonction) {
		String retour = null;
		try {
			if (fonction.matches("[^A-Za-zü-ÿ]") == false) {
				retour = fonction;
			}
		} catch (Exception e) {
