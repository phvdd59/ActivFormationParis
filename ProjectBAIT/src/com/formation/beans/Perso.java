...
public class Perso implements Serializable {
	public static final int FEMININ = 0;
	...
	private String pos; // apha - ' espace
	...
	private Date dateModification; // HH-MM-SS JJ-MM-AAAA
	...
	public String toString() {
		return "Perso [idPersonne=" + idPersonne + ", nom=" + nom + ", prenom=" + prenom + ", identifiant=" + identifiant + "]";
	}
