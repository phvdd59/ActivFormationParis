...
public class VerifComplet {
	...
	public boolean validTotal(HttpSession session) {
		...
		// if (personne.getLieuNaissance().equals("") &&
		// personne.getLieuNaissance()!= null) {
		// somme+=1;
		// }
		// if (personne.getNationalite().equals("") &&
		...
		// if (personne.getPosition().equals("") &&
		// personne.getPosition()!=null) {
		// somme+=1;
		// }
	...
	public boolean validECiv(HttpSession session) {
		Personne personne = (Personne) session.getAttribute("Personne");
		int somme = 0;
		boolean ok = false;
		if (personne.getDateNaissance().equals("") && personne.getDateNaissance() != null) {
	...
	public boolean validCoord(HttpSession session) {
		Personne personne = (Personne) session.getAttribute("Personne");
		int somme = 0;
		boolean ok = false;
		if (personne.getAdresse().equals("") && personne.getAdresse() != null) {
	...
	public boolean validSitu(HttpSession session) {
		Personne personne = (Personne) session.getAttribute("Personne");
		int somme = 0;
		boolean ok = false;
	...
	public boolean validSalaire(HttpSession session) {
		Personne personne = (Personne) session.getAttribute("Personne");
		int somme = 0;
		boolean ok = false;
		if (personne.getFonction().equals("") && personne.getFonction() != null) {
