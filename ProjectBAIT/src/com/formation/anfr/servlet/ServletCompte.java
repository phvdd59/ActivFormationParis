 ...
 */
@WebServlet(value = "/ServletCompte", name = "ServletCompte")
public class ServletCompte extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		File file2 = new File(
				"C:/DevFormation/GITActivFormationParis/ProjectEtudiant/WebContent/WEB-INF/com/formation/bait/pages/candidat.html");
