...
%>
	Eleve
	<%= nom %>
	<br /> Nombre de bonnes réponses
	<%= nbr %><br /> voulez vous un Autre exercice pour ?
	<br />
	<a href="http://localhost:8080/ProjectJSP/jsp/sessionQ.jsp">"<%= nom %>"
	</a>
	<br />
	<a href="../preQbeba.html"> un Autre Eleve</a>
