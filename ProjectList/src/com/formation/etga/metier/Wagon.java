...
//		return toString().compareTo(w.toString()); // rangement par ordre alphabetique
//		return Float.valueOf(getLng()).compareTo(Float.valueOf(w.getLng())); // rangement par taille de wagon
	}
}
