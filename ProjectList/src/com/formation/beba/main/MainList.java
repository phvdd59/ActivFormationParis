...
import com.formation.beba.metier.Entrepot;
import com.formation.beba.metier.Entrepot2;
import com.formation.beba.metier.TypeWagon;
import com.formation.beba.metier.Wagon;
import com.formation.beba.metier.WagonResto;
...
public class MainList {
	...
	public void init() {
		...
		map.put("un", new Integer(1)); // tree maps conserve en 1er une clé et
										// en 2ie valeur un objet
		...
		mapEntrepot.put(TypeWagon.WAGON_RESTO.getType(), new ArrayList<Wagon>());
		WagonResto w2 = new WagonResto(450);
		mapEntrepot.get(TypeWagon.WAGON_RESTO.getType()).add(w2);
		...
		System.out.println(hashTable); // ecrase les valeurs si change, refuse
										// les null
		...
		// entry converti une map sous forme de set (set etant une sorte de
