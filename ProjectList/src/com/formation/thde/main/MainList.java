...
import com.formation.thde.metier.Entrepot;
import com.formation.thde.metier.TypeWagon;
import com.formation.thde.metier.Wagon;
import com.formation.thde.metier.WagonResto;
...
public class MainList {
	...
	public void init() {
		...
		mapEntrepots.put(TypeWagon.WAGON_RESTO.getType(), lstWagon);
		ArrayList<Wagon> lstNew = mapEntrepots.get(TypeWagon.WAGON_RESTO.getType());
		mapEntrepots.get(TypeWagon.WAGON_RESTO.getType()).add(w1);
		WagonResto w2 = new WagonResto(450);
		mapEntrepots.get(TypeWagon.WAGON_RESTO.getType()).add(w2);
