...
/**
 * Servlet implementation class Servlet1Issa
 */
@WebServlet(value="/Servlet1Issa", name="Servlet1Issa");
public class Servlet1Issa extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// récupérer les paramètres.
				...
				File f = new File("C:/DevFormation/GITActivFormationParis/" + "ProjectEtudiant/WebContent/WEB-INF/com/" + "formation/issa/page/Identifiant.html");
				...
				Cookie monCookie = new Cookie("nom", "Isma");
...
//		RequestDispatcher dispatcher = context.getRequestDispatcher("/ServletPersonneIssa");
...
//				if (noSerie.equals(recupNoSerie)) {
					...
					if (pseudo != null && noSerie != null && !noSerie.equals("%%noserie%%")) {
						...
						File f = new File("C:/DevFormation/" + "GITActivFormationParis/ProjectEtudiant/" + "WebContent/WEB-INF/com/formation/issa/" + "page/PageCandidat.html");
						BufferedReader bIn = new BufferedReader(new FileReader(f));
						String l = bIn.readLine();
						while (l != null) {
						...
						bIn.close();
									...
									File f = new File("C:/DevFormation/GITActivFormationParis/"
											...
											+ "formation/issa/page/Identifiant.html");
									BufferedReader bIn = new BufferedReader(new FileReader(f));
									String l = bIn.readLine();
									while (l != null) {
										if (l.contains("identifiant")) {
											l=l.replace("value=''", "value='"+pseudo+" Erreur'");
										}
										resp.getWriter().println(l);
										l = bIn.readLine();
									}
			...
			dispatcher = context.getRequestDispatcher("/ServletPersonneIssa");
			dispatcher.forward(req, resp);
		}
	}
