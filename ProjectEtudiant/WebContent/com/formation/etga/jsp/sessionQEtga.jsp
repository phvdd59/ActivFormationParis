...
if (request.getParameter("nom") != null){
	...
	if (session.getAttribute("nb1") != null){
		...
		String rep = request.getParameter("essai");
		if ((rep.matches("[^0-9]+")) ||(rep.equals(""))){
			rep = "0";
		}
		int essai=Integer.parseInt(rep);
		if (essai == n1*n2) {
...
<% 
	...
	if (nq <= 3) {
		...
		%>
		<form method="get" action="sessionQEtga.jsp">
		...
		%>
		<jsp:forward page="sessionREtga.jsp"/>
		<%
	}
%>
</body>
