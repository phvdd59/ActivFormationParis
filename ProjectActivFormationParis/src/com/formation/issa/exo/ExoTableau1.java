...
public class ExoTableau1 implements InterExoTableau1 {
	 ...
	 * 
	 * @param d = valeur de départ
	 * @param n = nb d'élément
	 * @param p = pas entre chaque élément
	 * @param  
	...
	/** Exemple
	 * tab = [7,10,13,16,19,21,24,27,30] i1=3 , i2=8 tab = [7,10,27,16,19,21,24,13,30]
	 * @param tab tableau en entrée
	 * @param i1 première position pour l'interversion
	 * @param i2 deuxième position pour l'interversion
	 * @return 
	 */
	 ...
	 * @param tab tableau de départ
	 * @param p position où il faut remplacer les valeurs du premier tableau par celles du second     
	 * @param tab1 tableau contenant les valeurs de remplacement
	 * @return tableau 
	 */
	 ...
	 * @param tab tableau de départ
	 * @param p position : décaler le tableau vers la droite de p positions 
	 * 			et les p élements de la fin du tableau reviennent en début de tableau
	 * @return
	 */
