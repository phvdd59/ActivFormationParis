...
public class ExoAlgo6 implements InterAlgo6 {
	 ...
	 * tableau tab constitué d'entiers positifs. Afin de ne pas être affecté
	 * par des valeurs ponctuelles anormales il sera nécessaire de lisser
	 * chaque élement du tableau par ses "n" voisins à gauche et à droite
	 * les plus proches, avant de calculer sur une fenêtre de "f" valeurs
	 * correspondantes à une période celle la plus favorable (ie celle dont
	 * la somme la plus importante). Attention on ne s'intéressera pas aux n
	 * premiers éléments et aux n derniers éléments.
	 * 
	 * example : n=2 f=3 24 27 20 ---------------- ----------------
	 * ---------------- | . | | . | | . | tab = [1 ,4 ,7 ,8 ,4 ,3 ,7 ,2 ,8
	 * ,9 ,2 ,6 ,3 ,4 ,1 ,7 ,9 ,1 ,1 ,2 ] . . . . . . 29 28 27 22 19 20 | |
	 * | | ---------- ---------- . . 84 61
	 * 
	 ...
	 * correspondant à la fenêtre "f" la plus favorable avec un lissage de n
	 * de part et d'autre. En cas d'impossibilité renvoyer -1
	 */
