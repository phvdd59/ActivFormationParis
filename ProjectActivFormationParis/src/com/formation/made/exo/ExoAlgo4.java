...
public class ExoAlgo4 implements com.formation.phva.exo.InterAlgo4 {
	...
	/**
	 * ma methode solution doit intégrer une liste de terme sous forme d'un tableau à deux dimensions
	 * 
	 * 
	 * example :
	 * 
	 ...
	 *
	 * les cas annormaux seront traité en grande partie sur la base des exeption cruciExeption.
	 * 
	 */
	@Override
