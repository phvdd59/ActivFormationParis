...
public class ExoAlgo5 implements com.formation.phva.inter.InterAlgo5 {
	/*
	 * Besoin : Le service marketing de IKAE souhaite connaître ses n meubles, d'un certain type, les plus vendues il a à sa disposition issue de la bbd un tableau contenant tous les articles vendu depuis 10 ans représenté par son seul numéro de référence :
	 * 
	 * - chaque référence est un nombre de 9 chiffres - les 6 premiers chiffres représentent un groupe de meuble. - les 3 derniers chiffres correspond dans ce groupe un type particulier de meuble. - exemple : table basse "435678004" table haute "435678158" armoire haute 3 portes "001451054" armoire basse 2 portes "001451007" On ne s'interessera qu'au meubles par exemple d'armoire : "001451...")
	 * 
	 * en parametre - tab : tableau de référence des articles vendus - cat : le numéro a 6 chiffres des meubles qui nous intéresse. - n : nombre d'armoires souhaitée retourner - le tableau dans l'odre décroissant des n armoires les plus vendus
	 * 
