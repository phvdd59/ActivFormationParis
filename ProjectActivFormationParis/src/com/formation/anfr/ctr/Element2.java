...
public class Elmt implements Comparable<Elmt> {
	...
	public Element(TRI tri, int numero, String nom, int nb, String unite, float longeur, float largeur, float hauteur) {
		super();
		this.tri = tri;
		this.numero = numero;
		this.nom = nom;
	...
	public Element(TRI tri, int numero, String nom, int nb, float longeur, float largeur, float hauteur) {
		super();
		this.tri = tri;
		this.numero = numero;
		this.nom = nom;
