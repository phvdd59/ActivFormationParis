...
public class MainEnum {
	...
	public void init() {
		...
		case TABLE:
			...
			break;
		case CHAISE:
			System.out.println("Je m'assieds dessus !");
			break;
		case ARMOIRE:
		...
		System.out.println("Dimension (" + // 
				Meuble.TABLE.getLongueur() + "," + // 
				Meuble.TABLE.getLargeur() + "," + //
				Meuble.TABLE.getHauteur() + ")");
		System.out.println(Meuble.CHAISE.estDansLaCuisine());
